...
type escalationRepository struct{ db *sql.DB }

// NewEscalationRepository creates a MySQL-backed repository.EscalationRepository.
func NewEscalationRepository(db *sql.DB) repository.EscalationRepository {
