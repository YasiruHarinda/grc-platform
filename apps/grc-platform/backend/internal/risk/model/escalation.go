...
type Escalation struct {
	...
	// medium/low escalation and who can see the risk.
	AssignerLeadEmail    *string   `json:"assigner_lead_email"`
	ActionOwnerLeadEmail *string   `json:"action_owner_lead_email"`
