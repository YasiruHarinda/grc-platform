...
// ListTeamsFilter controls which teams are returned by GET /api/v1/risk/teams.
...
// CreateTeamRequest is the payload for POST /api/v1/risk/teams.
...
// UpdateTeamRequest is the payload for PUT /api/v1/risk/teams/{id}.
