...
// handleListComplianceReferences serves GET /api/v1/risks/compliance-references.
//
...
// handleCreateComplianceReference serves POST /api/v1/risks/compliance-references —
...
// handleUpdateComplianceReference serves PUT /api/v1/risks/compliance-references/{id}.
...
// handleDeleteComplianceReference serves DELETE /api/v1/risks/compliance-references/{id}.
